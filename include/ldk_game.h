...
/* Generated by Comet. Call once during game_initialize, before systems start.
 * Failure removes only systems registered by this call. Existing registrations
 * are preserved; a duplicate registration is an error, not an update.
 */
